...
def generate_launch_description():
    ...
    default_xacro = os.path.join(pkg, 'urdf', 'uf_slider_instance.urdf.xacro')
    default_rviz  = os.path.join(pkg, 'rviz', 'uf_slider.rviz')  # optional

    # ---- Args ----
    xacro_arg = DeclareLaunchArgument(
        'model', default_value=default_xacro,
        description='Path to uf_slider_instance .xacro (instance file)'
    )

    prefix_arg = DeclareLaunchArgument(
        'prefix', default_value='slider_',
