...
def generate_launch_description():
    pkg = get_package_share_directory('scene_description')
    default_xacro = os.path.join(pkg, 'urdf', 'dual_arm_scene.urdf.xacro') # With scene
    default_xacro = os.path.join(pkg, 'urdf', 'dual_arm_no_scene.urdf.xacro') # Without scene
    default_rviz  = os.path.join(pkg, 'rviz', 'dual_arm_scene.rviz')  
    ...
    mesh_pkg_arg    = DeclareLaunchArgument('mesh_pkg', default_value='scene_description')
